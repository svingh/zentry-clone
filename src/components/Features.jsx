    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
          ...
          <div className='relative border-hsla col-span-2 overflow-hidden rounded-md transition-transform duration-300 ease-out row-span-1
          ms-32 md:col-span-1 md:ms-0'>
          <BentoCard
          ...
          <div className='bento-tilt_2'>
              <div className='flex size-full flex-col justify-between bg-violet-900 border-violet-950 border-4 rounded-2xl p-5'> 
                <h1 className='bento-title special-font max-w-64 text-black'>More coming soon</h1>
                <TiLocationArrow className='m-3 scale-[5] self-end'/>
              </div>
          </div>
          <div className='bento-tilt_2'>
            <video
